...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2020 at 12:38 PM
...
('environment', 'development', '2020-02-01 11:35:06', '2020-02-01 11:35:06');
...
ALTER TABLE `users`
  ...
  ADD UNIQUE KEY `index_users_on_unlock_token` (`unlock_token`);
